...
function StudentViewCourseDetailsPage() {
  ...
  return (
    <div className=" mx-auto p-4">
      <div className="text-white p-8 rounded-t-lg bg-gold font-bold">
        ...
        <aside className="w-full md:w-[500px]">
          <Card className="sticky top-4">
            <CardContent className="p-6">
              ...
              <Button onClick={handleCreatePayment} className='w-full bg-blue-500 hover:bg-blue-600 text-white py-2 px-4 rounded'>
                Buy Now
              </Button>
            </CardContent>
          </Card>
