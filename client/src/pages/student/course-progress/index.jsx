    ...
    <div className='flex flex-col h-screen bg-[#1c1d1f] text-white'>
      ...
      <div 
        className={`flex-1 transition-all duration-300 ${
          isSideBarOpen ? 'md:mr-[400px]' : 'md:mr-0'
        }`}
      >
        <div className='relative w-full aspect-video max-h-[calc(100vh-180px)]'>
          <VideoPlayer
            width='100%'
            height='100%'
      ...
      <div
        className={`fixed top-[64px] right-0 bottom-0 w-full md:w-[400px] bg-[#1c1d1f] border-l border-gray-700 
      ...
      <Button 
        ...
        className='md:hidden fixed bottom-4 right-4 rounded-full w-12 h-12 flex items-center justify-center z-50 bg-primary shadow-lg'
      >
        {isSideBarOpen ? (
